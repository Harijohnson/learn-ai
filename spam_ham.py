data = [
	...
	("Fine if that shredded the way u feel. That shredded the way its gota b", "ham"),
	...
	("I'was going to try for 2 months ha ha only joking", "ham"),
	...
	("/Oops, I'll let you know when my roommate's done", "ham"),
	...
	("Did I forget to tell you ? I want you , I need you, I crave you ... But most of all ... I love you my sweet Arabian steed ... Mmmmmm ... Yummy", "ham"),
	...
	("Yeah hopefully, if tyler can't do it I could maybe ask around a bit", "ham"),
	...
	("A gram usually runs like  &lt;#&gt; , a half eighth is smarter though and gets you almost a whole second gram for  &lt;#&gt;", "ham"),
	("K fyi x has a ride early tomorrow morning but he's crashing at our place tonight", "ham"),
	("Wow. I never realized that you were so embarassed by your accomodations. I thought you liked it, since i was doing the best i could and you always seemed so happy about the cave'. I'm sorry I didn't and don't have more to give. I'm sorry i offered. I'm sorry your room was so embarassing.", "ham"),
	...
	("Sorry, I'll call later in meeting.", "ham"),
	...
	("That's cool. i am a gentleman and will treat you with dignity and respect.", "ham"),
	...
	("Yup next stop.", "ham"),
	("I call you later, don't have network. If urgnt, sms me.", "ham"),
	...
	("Ela kano.,il download, come wen ur free..", "ham"),
	...
	("Your free ringtone is waiting to be collected. Simply text the password MIX' to 85069 to verify. Get Usher and Britney. FML PO Box 5249", "spam"),
